    ...
    >
      <div class="normal-player" v-show="fullScreen">
        <div class="background">
          <img width="100%" height="100%" :src="currentSong.image"></img>
        </div>
        <div class="top">
...
<script>
  ...
  import {playerMixin} from 'common/js/playerMixin'
  ...
  export default {
    ...
    methods: {
      ...
      _getPosAndScale(){
        const smallWidth = 40
        const smallCenterLeft = 40
        const smallCenterBottom = 30
        const largeTop = 80
        const largeWidth = window.innerWidth * 0.8
        const scale = smallWidth / largeWidth
        const x = -(window.innerWidth / 2 - smallCenterLeft)
        const y = window.innerHeight - largeTop - largeWidth / 2 - smallCenterBottom
        return {
          x,
          y,
          scale
